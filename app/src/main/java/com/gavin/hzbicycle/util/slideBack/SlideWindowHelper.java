package com.gavin.hzbicycle.util.slideBack;
...
import com.gavin.hzbicycle.application.HZBicycleApplication;
...
public class SlideWindowHelper extends Handler {
    ...
    class ViewManager {
        ...
        private boolean addViewFromPreviousActivity() {
            ...
            HZBicycleApplication application = (HZBicycleApplication) mCurrentWindow.getContext().getApplicationContext();
